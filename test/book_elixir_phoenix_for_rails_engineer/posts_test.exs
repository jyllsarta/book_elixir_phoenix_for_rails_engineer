defmodule BookElixirPhoenixForRailsEngineer.PostsTest do
  use BookElixirPhoenixForRailsEngineer.DataCase
  ...
  describe "posts" do
    ...
    # Plug.Upload 構造体を使って、画像込みで投稿を保存する
    @valid_attrs %{
      body: "some body",
    ...
    # Pow.Operations.create/1 でユーザを作成できる
    ...
    test "create_post/1 with invalid image data returns error changeset" do
      ...
      assert {:error, :post_with_image, %Ecto.Changeset{} = changeset, _} =
