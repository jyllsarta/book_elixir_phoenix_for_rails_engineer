...
config :book_elixir_phoenix_for_rails_engineer, BookElixirPhoenixForRailsEngineer.Repo,
  username: "postgres",
  password: "postgres",
  database: "book_elixir_phoenix_for_rails_engineer_dev",
  hostname: "localhost",
...
config :book_elixir_phoenix_for_rails_engineer, BookElixirPhoenixForRailsEngineerWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/book_elixir_phoenix_for_rails_engineer_web/(live|views)/.*(ex)$",
      ~r"lib/book_elixir_phoenix_for_rails_engineer_web/templates/.*(eex)$"
    ]
  ]
